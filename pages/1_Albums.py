...
albums_df = pd.read_csv('https://raw.githubusercontent.com/sargones/spotify_streamlit_steps/refs/heads/main/pages/albums.csv?token=GHSAT0AAAAAACZRTOVPNQFK6TZ5KUXTAXFUZZCRSGA')
